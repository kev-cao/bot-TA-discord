...
module.exports.description = "Adds a topic suggestion to the list. Max characters is 30.";
...
module.exports.run = (client, message, args) => {
  ...
  if (client.suggestions.length >= 10) {
    ...
    str = `Please provide a suggestion after the command. (e.g. \`${client.config.prefix}tsuggest suggestion\`).`;
